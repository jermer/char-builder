...
export const options = {
    ...
    abilityDescriptions: {
        'str': "bodily power, physical force, gross motor skills",
        'dex': "agility, reflexes, fine motor skills",
        'con': "health, vitality, stamina, endurance",
        'int': "mental acuity, accuracy of recall, reasoning",
        'wis': "intuition, attunement, situational awareness",
        'cha': "confidence, charm, eloquence, personality",
    },
    abilityTooltips: {
        'str': ["Strength", "bodily power, physical force, gross motor skills"],
        'dex': ["Dexterity", "agility, reflexes, fine motor skills"],
        'con': ["Constitution", "health, vitality, stamina, endurance"],
        'int': ["Intelligence", "mental acuity, accuracy of recall, reasoning"],
        'wis': ["Wisdom", "intuition, attunement, situational awareness"],
        'cha': ["Charisma", "confidence, charm, eloquence, personality"],
    },
    abilityPresets: {
        'cleric': ['wis', 'str', 'con', 'cha', 'cha', 'dex'],
        'druid': ['wis', 'dex', 'con', 'str', 'cha', 'int'],
        'ranger': ['dex', 'wis', 'con', 'str', 'int', 'cha'],
        'rogue': ['dex', 'cha', 'con', 'wis', 'int', 'str'],
        'warrior': ['str', 'con', 'cha', 'dex', 'wis', 'int'],
        'wizard': ['int', 'dex', 'con', 'wis', 'cha', 'str'],
        'default': ['str', 'dex', 'con', 'int', 'wis', 'cha']
    },
    // character classes and their tooltips
    classList: [
        new heroItem("cleric", "a front-line fighter who also channels healing magic", ["str", "cha"]),
        new heroItem("druid", "a magic-user who embodies the primal power of nature", ["dex", "wis"]),
        new heroItem("ranger", "a long-range fighter with superior wildnerness skills", ["dex", "con"]),
        new heroItem("rogue", "a shadowy figure with a talent for sneaking and subterfuge", ["dex", "cha"]),
        new heroItem("warrior", "a front-line fighter who can inspire their allies", ["str", "con"]),
        new heroItem("wizard", "a magic-user with a broad variety of arcane skills", ["int", "wis"]),
    ],
    ...
    gearList: [
        ...
        new gearItem("glass jug and stopper"),
